    ...
    <div className="min-h-screen flex flex-col animate-[fade-in-up_0.6s_ease-out]">
      ...
      <main className="flex-1 w-full">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 py-8">
          <div className="card-glass rounded-3xl p-6 animate-[fade-in-up_0.6s_ease-out]">
      ...
      {status === 'loading' && (
        <div className="fixed inset-0 flex flex-col items-center justify-center glass-effect-strong bg-[var(--background)]/60 animate-[fade-in-up_0.3s_ease-out]">
          <BreathingLoader className="w-32 h-32 animate-[float_3s_ease-in-out_infinite]" />
